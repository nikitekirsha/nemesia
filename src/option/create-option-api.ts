...
export function createOptionApi(
  root: HTMLElement,
  ...
  const fail = (
    ...
    throw new SkipComponentMountError(
      reason,
      diagnosticPayload(name, attribute, expected, received),
    )
  }
  ...
  const literal = <T extends OptionLiteral>(
    ...
    return resolve(
      ...
      raw => {
        ...
        return Object.is(parsed, literalValue)
          ? valid(literalValue)
          : invalid()
      },
      options,
  ...
  function optionalString(
    name: string,
    options: StringOptionOptions & { default: string },
  ): string
  function optionalString(
    name: string,
    options?: StringOptionOptions,
  ...
  function optionalNumber(
    name: string,
    options: NumberOptionOptions & { default: number },
  ): number
  function optionalNumber(
    name: string,
    options?: NumberOptionOptions,
  ...
  function optionalBoolean(
    name: string,
    options: BooleanOptionOptions & { default: boolean },
  ): boolean
  function optionalBoolean(
    name: string,
    options?: BooleanOptionOptions,
  ...
  function optionalJson<T>(
    name: string,
    options: JsonOptionOptions<T> & { default: T },
  ): T
  function optionalJson<T>(
    name: string,
    options?: JsonOptionOptions<T>,
  ...
  const api = {
    ...
    json: <T>(name: string, options?: JsonOptionOptions<T>) =>
      json(true, name, options) as T,

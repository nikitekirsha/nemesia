...
export type ComponentDiagnosticContext =
...
function emitWarning(
  message: string,
  createPayload: DiagnosticPayloadFactory,
): void {
  try {
...
export function reportDestroyError(
  component: string,
  context: ComponentDiagnosticContext,
  error: unknown,
): void {
...
export function warnSkippedComponent(
  component: string,
  reason: string,
  payload: DiagnosticPayload,
): void {
  emitWarning(
    `[Nemesia] Component "${component}" skipped: ${reason}.`,
    () => payload,
  )
}

export function reportConstructionError(
  component: string,
  context: ComponentDiagnosticContext,
  error: unknown,
): void {
...
export function reportMountError(
  component: string,
  context: ComponentDiagnosticContext,
  error: unknown,
): void {

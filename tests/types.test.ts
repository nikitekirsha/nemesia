...
describe('public TypeScript contracts', () => {
  it('narrows roots and every ref family', () => {
    ...
    expectTypeOf<InstanceType<typeof DefaultRoot>['root']>()
      .toEqualTypeOf<HTMLElement>()
    expectTypeOf<InstanceType<typeof TypedRefs>['root']>()
      .toEqualTypeOf<HTMLFormElement>()
    expectTypeOf<InstanceType<typeof TypedRefs>['element']>()
      .toEqualTypeOf<HTMLElement>()
    expectTypeOf<InstanceType<typeof TypedRefs>['button']>()
      .toEqualTypeOf<HTMLButtonElement>()
    expectTypeOf<InstanceType<typeof TypedRefs>['input']>()
      .toEqualTypeOf<HTMLInputElement>()
    expectTypeOf<InstanceType<typeof TypedRefs>['textarea']>()
      .toEqualTypeOf<HTMLTextAreaElement>()
    expectTypeOf<InstanceType<typeof TypedRefs>['select']>()
      .toEqualTypeOf<HTMLSelectElement>()
    expectTypeOf<InstanceType<typeof TypedRefs>['form']>()
      .toEqualTypeOf<HTMLFormElement>()
    expectTypeOf<InstanceType<typeof TypedRefs>['svg']>()
      .toEqualTypeOf<SVGSVGElement>()
    expectTypeOf<InstanceType<typeof TypedRefs>['optionalElement']>()
      .toEqualTypeOf<HTMLElement | null>()
    expectTypeOf<InstanceType<typeof TypedRefs>['optionalButton']>()
      .toEqualTypeOf<HTMLButtonElement | null>()
    expectTypeOf<InstanceType<typeof TypedRefs>['optionalInput']>()
      .toEqualTypeOf<HTMLInputElement | null>()
    expectTypeOf<InstanceType<typeof TypedRefs>['optionalTextarea']>()
      .toEqualTypeOf<HTMLTextAreaElement | null>()
    expectTypeOf<InstanceType<typeof TypedRefs>['optionalSelect']>()
      .toEqualTypeOf<HTMLSelectElement | null>()
    expectTypeOf<InstanceType<typeof TypedRefs>['optionalForm']>()
      .toEqualTypeOf<HTMLFormElement | null>()
    expectTypeOf<InstanceType<typeof TypedRefs>['optionalSvg']>()
      .toEqualTypeOf<SVGSVGElement | null>()
    expectTypeOf<InstanceType<typeof TypedRefs>['elements']>()
      .toEqualTypeOf<HTMLElement[]>()
    expectTypeOf<InstanceType<typeof TypedRefs>['buttons']>()
      .toEqualTypeOf<HTMLButtonElement[]>()
    expectTypeOf<InstanceType<typeof TypedRefs>['inputs']>()
      .toEqualTypeOf<HTMLInputElement[]>()
    expectTypeOf<InstanceType<typeof TypedRefs>['textareas']>()
      .toEqualTypeOf<HTMLTextAreaElement[]>()
    expectTypeOf<InstanceType<typeof TypedRefs>['selects']>()
      .toEqualTypeOf<HTMLSelectElement[]>()
    expectTypeOf<InstanceType<typeof TypedRefs>['forms']>()
      .toEqualTypeOf<HTMLFormElement[]>()
    expectTypeOf<InstanceType<typeof TypedRefs>['svgs']>()
      .toEqualTypeOf<SVGSVGElement[]>()
    expectTypeOf<InstanceType<typeof TypedRefs>['optionalElements']>()
      .toEqualTypeOf<HTMLElement[]>()
    expectTypeOf<InstanceType<typeof TypedRefs>['optionalButtons']>()
      .toEqualTypeOf<HTMLButtonElement[]>()
    expectTypeOf<InstanceType<typeof TypedRefs>['optionalInputs']>()
      .toEqualTypeOf<HTMLInputElement[]>()
    expectTypeOf<InstanceType<typeof TypedRefs>['optionalTextareas']>()
      .toEqualTypeOf<HTMLTextAreaElement[]>()
    expectTypeOf<InstanceType<typeof TypedRefs>['optionalSelects']>()
      .toEqualTypeOf<HTMLSelectElement[]>()
    expectTypeOf<InstanceType<typeof TypedRefs>['optionalForms']>()
      .toEqualTypeOf<HTMLFormElement[]>()
    expectTypeOf<InstanceType<typeof TypedRefs>['optionalSvgs']>()
      .toEqualTypeOf<SVGSVGElement[]>()
  ...
  it('types every required, optional, and defaulted option overload', () => {
    ...
    class TypedOptions extends Nemesia.Component('typed-options') {
      ...
      defaultJson = this.option.optional.json<{ ok: boolean }>(
        'defaultJson',
        new GetterJsonOptions(),
      )
      defaultEnum = this.option.optional.enum(
        'defaultEnum',
        enumValues,
        new GetterEnumOptions(),
      )
      defaultLiteral = this.option.optional.literal(
        'defaultLiteral',
        3,
        new GetterLiteralOptions(),
      )
      defaultCustom = this.option.optional.custom(
        'defaultCustom',
        parser,
        validator,
        new GetterCustomOptions(),
      )
    }
    ...
    expectTypeOf<InstanceType<typeof TypedOptions>['json']>()
      .toEqualTypeOf<{ ok: boolean }>()
    expectTypeOf<InstanceType<typeof TypedOptions>['enum']>()
      .toEqualTypeOf<'light' | 'dark'>()
    expectTypeOf<InstanceType<typeof TypedOptions>['literal']>().toEqualTypeOf<3>()
    expectTypeOf<InstanceType<typeof TypedOptions>['custom']>()
      .toEqualTypeOf<{ value: number }>()

    expectTypeOf<InstanceType<typeof TypedOptions>['optionalString']>()
      .toEqualTypeOf<string | undefined>()
    expectTypeOf<InstanceType<typeof TypedOptions>['optionalNumber']>()
      .toEqualTypeOf<number | undefined>()
    expectTypeOf<InstanceType<typeof TypedOptions>['optionalBoolean']>()
      .toEqualTypeOf<boolean | undefined>()
    expectTypeOf<InstanceType<typeof TypedOptions>['optionalJson']>()
      .toEqualTypeOf<{ ok: boolean } | undefined>()
    expectTypeOf<InstanceType<typeof TypedOptions>['optionalEnum']>()
      .toEqualTypeOf<'light' | 'dark' | undefined>()
    expectTypeOf<InstanceType<typeof TypedOptions>['optionalLiteral']>()
      .toEqualTypeOf<3 | undefined>()
    expectTypeOf<InstanceType<typeof TypedOptions>['optionalCustom']>()
      .toEqualTypeOf<{ value: number } | undefined>()

    expectTypeOf<InstanceType<typeof TypedOptions>['defaultString']>()
      .toEqualTypeOf<string>()
    expectTypeOf<InstanceType<typeof TypedOptions>['defaultNumber']>()
      .toEqualTypeOf<number>()
    expectTypeOf<InstanceType<typeof TypedOptions>['defaultBoolean']>()
      .toEqualTypeOf<boolean>()
    expectTypeOf<InstanceType<typeof TypedOptions>['defaultJson']>()
      .toEqualTypeOf<{ ok: boolean }>()
    expectTypeOf<InstanceType<typeof TypedOptions>['defaultEnum']>()
      .toEqualTypeOf<'light' | 'dark'>()
    expectTypeOf<InstanceType<typeof TypedOptions>['defaultLiteral']>()
      .toEqualTypeOf<3>()
    expectTypeOf<InstanceType<typeof TypedOptions>['defaultCustom']>()
      .toEqualTypeOf<{ value: number }>()
  })
  ...
  it('infers single and readonly-array event listener arguments', () => {
    class EventTypes extends Nemesia.Component('event-types') {
      check(
        ...
        targets: readonly HTMLInputElement[],
      ): void {
  ...
  it('accepts all component constructors and enforces array registration', () => {
    class LiteralRoot extends Nemesia.Component('literal-root', { root: 'form' }) {}
    const unionTag: 'form' | 'button' = Math.random() > 0.5 ? 'form' : 'button'
    class UnionRoot extends Nemesia.Component('union-root', { root: unionTag }) {}
  ...
  it('exposes only scope/on/warn on distributed component instances', () => {
    ...
    expectTypeOf<InstanceType<typeof Distributed>['scope']>()
      .toEqualTypeOf<ParentNode>()
  })
  ...
  it('keeps factories usable inline or stored and exports the deliberate public types', () => {
    ...
    expectTypeOf<InstanceType<typeof StoredComponent>['root']>()
      .toEqualTypeOf<HTMLElementTagNameMap['main']>()
    expectTypeOf<InstanceType<typeof InlineComponent>['root']>()
      .toEqualTypeOf<HTMLElement>()
    expectTypeOf<InstanceType<typeof StoredDistributedComponent>['scope']>()
      .toEqualTypeOf<ParentNode>()
    expectTypeOf<InstanceType<typeof InlineDistributedComponent>['scope']>()
      .toEqualTypeOf<ParentNode>()
